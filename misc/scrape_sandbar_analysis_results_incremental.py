...
resultfile = "D:/Temp/GCMRC/results_incremental.csv"
...
with open(resultfile, 'rb') as csvfile:
    ...
    for csvRow in csvReader:
        c.execute("INSERT INTO ModelResultsIncremental (RunID, SectionID, Elevation, Area, Volume) VALUES (?, ?, ?, ?, ?)", [nRunID, csvRow["sectionid"], csvRow["elevation"], csvRow["area"], csvRow["vol"] ])
        nRows += 1
